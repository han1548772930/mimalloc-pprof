/* GENERATED FILE -- DO NOT EDIT. Produced by rust/xtask from commit c7a1fbb7 of the public headers (mimalloc.h, mimalloc/profile.h, mimalloc/memory-events.h, mimalloc/dhat.h). Regenerate with: cargo run -p xtask -- amalgamate-h */
